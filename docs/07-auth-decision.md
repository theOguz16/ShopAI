...
HTTPS staging'de yeni hesap, doğrulama e-postası, MFA, parola kurtarma ve tarayıcılar arası logout-all daha önce gözlendi. İki bağımsız merchant/kullanıcı negatif testi, kapatma uçtan uca testi ve legacy pilot envanteri ayrıca doğrulanmadan ÜRÜN-003 kapanmış sayılmaz. Yerel PostgreSQL testleri bu dış kabulün yerine geçmez. Gerçek müşteri pilotu ÜRÜN-032 kapsamındadır. Ayrıntılı kanıt ve açık kapılar [Better Auth geçiş kaydında](follow-ups/urun-003-better-auth-migration.md).
